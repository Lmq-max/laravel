    ...
    <div class="registerCon">
        <ul>
            <li class="accAndPwd">
                ...
                {{--<dl>
                    <input  maxlength="11" type="text" placeholder="请输入验证码" value="" />
                    <input maxlength="11" type="text" placeholder="请输入验证码" value="" style="display: none" />
                    <span class="mr clear">x</span>
                    <s class="eyeclose"></s>
                    <img src="{{captcha_src()}}" id="vcode_img" onclick="changeVcode()" alt="">
                </dl>--}}
                <dl class="a-set">
...
<script>
    $(function(){
        ...
        $('#btnNext').click(function(){
            var vcode=$('#vcode_img').parent('dl').children('input').val();
            if(vcode==''){
                alert('请输入验证码');
                return false;
            }
