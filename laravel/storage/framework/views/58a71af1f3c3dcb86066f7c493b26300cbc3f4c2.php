...
<head>
    ...
    <link href="<?php echo e(env('STATIC_URL')); ?>/css/mywallet.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="wallet-con">
    <div class="w-item">
        <ul class="w-content clearfix">
            ...
            <li>
                <a href="">昵称</a>
                <s class="fr"></s>
                <span class="fr"><?php echo e(Session('user_info.user_email')); ?></span>
            </li>
            <li>
                <a href="">我的主页</a>
                <s class="fr"></s>
    ...
    <div class="quit">
        <a href="<?php echo e(url('quit')); ?>">退出登录</a>
    </div>
</div>
