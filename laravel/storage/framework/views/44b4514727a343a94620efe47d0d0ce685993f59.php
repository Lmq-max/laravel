...
<?php $__env->startSection('content'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>/css/css/bootstrap.css">
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>/css/css/iconfont.css">
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>/css/css/base.css">
    <link rel="stylesheet" href="<?php echo e(env('STATIC_URL')); ?>/css/css/goods.css">
    ...
    <div class="marginB" id="loadingPicBlock">
        <div class="goods-wrap marginB site-demo-fiow layui-field-title" style="margin-top:20px">
            ...
            <input type="hidden" value="<?php echo e($cid); ?>" id="cid">
                ...
                layui.use('flow', function() {
                    ...
                    flow.load({
                        ...
                        , done: function (page, next) {
                            $.get('<?php echo e(url('/prolist')); ?>?page='+page+'&cid='+cid+'&order_field='+order_field+'&order_type='+order_type,function (res) {
