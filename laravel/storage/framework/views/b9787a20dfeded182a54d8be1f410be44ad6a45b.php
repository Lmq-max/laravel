    ...
    <form class="layui-form" action="">
        <div class="registerCon">
            <ul>
                ...
                <li><p>我们已向<em class="red"><?php echo e($user_info); ?></em>发送验证码短信，请查看短信并输入验证码。</p></li>
                <li>
                    <input type="hidden" value="<?php echo e($user_info); ?>" id="tel">
